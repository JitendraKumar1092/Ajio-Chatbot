...
const TrendsAI = () => {
  ...
  return (
    <>
      ...
      <section className="w-full mx-auto bg-[#14141r] md:p-5 rounded-lg  mt-5 from-neutral-200 to-neutral-800 bg-clip-text">
        <div>
      ...
      <div className="flex flex-col items-center">
        <div className="max-w-xl mx-auto p-4">
          ...
          <form onSubmit={handleSubmit} className="flex items-center mt-4">
            <input
              className="h-14 w-80 bg-zinc-200 text-zinc-600 font-mono ring-1 ring-zinc-400 focus:ring-2 focus:ring-blue-400 outline-none duration-300 placeholder:text-zinc-600 placeholder:opacity-50 rounded-full px-4 py-2 shadow-sm focus:shadow-md focus:shadow-blue-400 "
              autoComplete="off"
            ...
            <button className="ml-6 h-13 hover:brightness-110 hover:animate-pulse font-bold py-3 px-6 rounded-full bg-green-500 shadow-lg shadow-indigo-500/50 text-white">
              Submit
            </button>
          </form>
        </div>
